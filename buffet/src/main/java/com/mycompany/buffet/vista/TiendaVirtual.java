package com.mycompany.buffet.vista;

import com.mycompany.buffet.controlador.ConexionDB;
...
private void agregarProductoAlCarrito() {
  ...
  private void confirmarReserva() {
    ...
    for (Reserva reserva : reservas) {
        ...
        conexionDB.insertarReserva(reserva, usuarioActual.getNombre());  // Pasa el nombre del usuario
    }
